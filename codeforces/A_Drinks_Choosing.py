...
def solve():
    ...
    for i in freq:
        ...
        if is_odd(val):
            found_odd +=1
            satisfied_student+=val-1
        else:
            satisfied_student+=val
    if found_odd and found_odd ==1:
        satisfied_student += 1
    else:
        satisfied_student+= ((found_odd-1)//2)+1
    print(satisfied_student)
    # print(freq)
