...
def solve():
    ...
    for _ in range(t):
        ...
        next_slice = n
        x = 3
        # print("gg",math.floor(8/3))
        while True:
            if math.floor(next_slice / 3) == 0:
                hao += 1
            else:
                hao += math.floor(next_slice / 3)
            # print(math.floor(next_slice / 3))
            next_slice = next_slice - (
                math.floor(next_slice / 3) + math.floor(next_slice / 3)
            )
            # print("next slice,",next_slice)
            if next_slice <= 2:
                break
            # x-=1
            # print(next_slice, hao)
        print(hao)
        # print("--------------")
